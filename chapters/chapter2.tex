...
We will explore further representations in chapter \ref{erchapter}.
...
In general, two complexes can be compared using the so-called {\color{red} something} distance.
